...
// BuildVersion is the version of tool.
const BuildVersion = "1.0.0"

var tag = map[string]int{"pre-alpha": 0, "alpha": 1, "pre-bata": 2, "beta": 3, "released": 4, "": 5}

// GetThisToolVersion returns BuildVersion
func GetThisToolVersion() string {
	return BuildVersion
}

// IsVersionGreaterThan compares whether the current tool version
...
func IsVersionGreaterThan(version, target string) bool {
	...
	if versionNumber > targetVersionNumber {
		...
		// unchecked case, in normal, the tool version does not contain suffix in release.
